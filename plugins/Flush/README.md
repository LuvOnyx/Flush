...
54 assertions measure the actual responses: exact center gain, boost/cut cancel-to-wire,
...
- [x] DSP core — written + **verified** (54/54 tests): filters, dynamics, loudness, FFT,
...
- [x] Visage UI (Pro-Q4 recreation + preset browser + settings modal) — written
