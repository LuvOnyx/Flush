...
- [x] UI interactions — right-click context menus (node type/dynamic/solo/remove; add band),
      double-click add band / reset node, drag nodes, keyboard delete/backspace + arrow nudge,
